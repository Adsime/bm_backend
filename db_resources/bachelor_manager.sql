...
CREATE TABLE IF NOT EXISTS `bm_database`.`INSTITUTION_AFFILIATION` (
  ...
  INDEX `fk_INSTITUTION_has_USER_USER1_idx` (`USER_id` ASC),
  INDEX `fk_INSTITUTION_has_USER_INSTITUTION1_idx` (`INSTITUTION_id` ASC),
  CONSTRAINT `fk_INSTITUTION_has_USER_INSTITUTION1`
    FOREIGN KEY (`INSTITUTION_id`)
    REFERENCES `bm_database`.`INSTITUTION` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_INSTITUTION_has_USER_USER1`
    FOREIGN KEY (`USER_id`)
    REFERENCES `bm_database`.`USER` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
