...
public class TestHibernateData {
    ...
    public static User getUser(){
        return new User(1,"David Josué Jiménez", "Silva", "merlin@mcfc.co.uk", "silva.david.j.j", getTagList());
    }

    public static User getUserWrongId(){
        return new User(0,"Yaya", "Toure", "nocake@mcfc.co.uk", "toure.yaya", getTagList());
    }
    ...
    public static List<HbnUser> getHbnUserList(){
        ...
        HbnUser hbnUser = new HbnUser("David Josué Jiménez", "Silva", "merlin@mcfc.co.uk","","silva.david.j.j");
        hbnUser.setId(1);
